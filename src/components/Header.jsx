...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="flex sm:grid sm:grid-cols-3 justify-between border-b w-full border-gray-300 px-6 sm:px-10 lg:px-20 py-4 fixed top-0 left-0 bg-white sm:relative">
