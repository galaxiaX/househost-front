...
export function IconUser({ className = defaultClass }) {
  return (
...
export function IconBook({ className = defaultClass }) {
  return (
...
export function IconHome({ className = defaultClass }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export function IconPhone({ className = defaultClass }) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
export function IconCalendar({ className = defaultClass }) {
  return (
    <svg
...
export function IconArrow({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function IconMoon({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function IconUserLine({ className = defaultClass }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export function IconCreditCard({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function IconBin({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function IconStar({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function IconStarFill({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconZoom({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconHamburger({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconGithub({ className = defaultClass }) {
  return (
...
export function IconLogin({ className = defaultClass }) {
  return (
    <svg viewBox="0 0 900 1000" fill="currentColor" className={className}>
...
export function IconUpload({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function IconEyeOff({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function IconEyeOn({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function IconSlideUp({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconLocation({ className = defaultClass }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export function IconPhoto({ className = defaultClass }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function IconTriangle({ className = defaultClass }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
